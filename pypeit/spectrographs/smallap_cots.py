...
GRATING_ANGLE = 'Standard'  # Something to identify the grating tilt
...
class COTSSpectrograph(spectrograph.Spectrograph):
    ...
    PLATE_SCALE = 206265. / TEL_FOCLEN / 1.0e3  # arcsec / mm
    PIXEL_SCALE = 0
    ...
    def get_detector_par(self, det, hdu=None):
        ...
        detector_dict = dict(
            ...
            mincounts       = -1e10,
            numamplifiers   = 1,
            gain            = GAIN,                     # e-/ADU (measured)
            ronoise         = READ_NOISE,               # e-
    ...
    def init_meta(self):
        ...
        # Required (core)
        self.meta['ra'] = dict(ext=0, card='OBJCTRA')
        self.meta['dec'] = dict(ext=0, card='OBJCTDEC')
